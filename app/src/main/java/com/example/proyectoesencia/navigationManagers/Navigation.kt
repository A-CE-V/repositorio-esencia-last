...
import com.example.proyectoesencia.ui.screens.creditScreen.CreditScreen
...
import com.example.proyectoesencia.ui.screens.settingsScreen.PlusScreen
...
fun NavigationManager(
    ...
    NavHost(
        ...
        composable(RutasSealed.MoreScreen.ruta) {
            PlusScreen(navController)
        }
        composable(RutasSealed.CreditScreen.ruta) {
            CreditScreen()
        }
    }
}
