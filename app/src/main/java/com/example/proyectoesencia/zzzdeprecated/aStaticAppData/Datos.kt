package com.example.proyectoesencia.zzzdeprecated.aStaticAppData
...
/*
val listaTodosLosFiltros = listOf(
    FilterDataClass(R.string.filter_fisicas),
    FilterDataClass(R.string.filter_quimicas),
    FilterDataClass(R.string.filter_biologas),
    FilterDataClass(R.string.filter_profesoras),
    FilterDataClass(R.string.filter_investigadora)
)*/

val listaTodosLosFiltros = listOf(
    "Física","Química","Bióloga","Profesora","Investigadora"
)
